...
class FuncRegistry:  # class definition
    ...
    RESERVED_FUNCS = [  # assignment
        ...
        # ── P57 扩展 2026-07-14：第三批 GB50974 通用/施工/验收（10条）+ GB50016 补充（6条）──
        # GB50974 通用/施工/验收（10条）
        AtomicFunction(
            func_id="DIM-051",
            name="消防水池取水口高度判定",
        ...
        # P57 扩展（第五批）：GB50974 消防给水系统 + 电气 + GB50763 无障碍
        AtomicFunction(
            func_id="DIM-059",
            name="消防水箱进水压力（高位水箱）",
        ...
        # ===== P57-6 GB 50067 汽车库/修车库（15条，2026-07-14）=====
        # DIM-065~074 尺寸/距离判定
        AtomicFunction(
            func_id="DIM-065",
            name="汽车疏散坡道宽度判定",
        ...
        # ===== P57-7 GB 50763 无障碍设计规范扩展（10条，2026-07-14）=====
        AtomicFunction(
            func_id="ACCESS-011",
            name="盲道宽度判定",
        ...
        # ═══════════════════════════════════════════════════════════════
        # P57 扩容：GB50016 防火规范补充（DIM-073~075 / COUNT-014~015 / EXIST-037~038）
        # GB50974 消防给水补充（DIM-076~077 / DIST-022~023）
        # ═══════════════════════════════════════════════════════════════
        AtomicFunction(
            func_id="DIM-073",
            name="消防电梯前室面积判定",
        ...
        # ═══════════════════════════════════════════════════════════════
        # P34 设备类实体识别：覆盖 8 个已识别但无原子函数检查的设备类型
        # ═══════════════════════════════════════════════════════════════
        AtomicFunction(
            func_id="EXIST-039",
            name="消防警铃设置判定",
        ...
        # ===== P58 GB50016 第5章民用建筑扩展（10条，2026-07-16）=====
        AtomicFunction(
            func_id="DIST-024",
            name="疏散距离判定（耐火等级二级）",
        ...
        # ===== P58 GB50016 第6章建筑构造扩展（11条，2026-07-16）=====
        AtomicFunction(
            func_id="EXIST-052",
            name="防火墙上不应开设门窗洞口判定",
        ...
        # ===== P58 GB50016 第7章消防车道/救援扩展（5条，2026-07-16）=====
        AtomicFunction(
            func_id="DIM-085",
            name="消防车道净高判定",
        ...
        # ===== P58 GB50016 第8章消防设施扩展（3条，2026-07-16）=====
        AtomicFunction(
            func_id="EXIST-055",
            name="消防水源判定",
        ...
        # ===== P58 GB50974 第7章消火栓系统扩展（9条，2026-07-16）=====
        AtomicFunction(
            func_id="DIST-025",
            name="消火栓间距判定",
        ...
        # ===== P57 末段扩展（10个，250→260）=====
        # GB50067-5.1.2: 汽车库防火分区间防火墙/防火卷帘应满足耐火极限要求
        AtomicFunction(
            func_id="EXIST-063",
            name="汽车库防火卷帘判定",
        ...
        # GB50067-5.1.4: 设有自动灭火系统时，防火分区面积可增加1倍
        AtomicFunction(
            func_id="DIM-091",
            name="汽车库自动灭火分区面积判定",
        ...
        # GB50067-8.2.2: 汽车库排烟量不应小于30000m³/h
        AtomicFunction(
            func_id="AREA-012",
            name="汽车库排烟量判定",
        ...
        # GB50016-5.5.17-2: 位于两个安全出口之间的疏散距离补充
        AtomicFunction(
            func_id="DIST-028",
            name="双向疏散距离判定",
        ...
        # GB50763-3.8.3: 无障碍通道门净宽不应小于0.80m
        AtomicFunction(
            func_id="DIM-092",
            name="无障碍通道门宽度判定",
        ...
        # GB50016-5.5.8: 公共建筑每个防火分区安全出口不应少于2个（补充COUNT系）
        AtomicFunction(
            func_id="COUNT-019",
            name="防火分区安全出口数量判定",
            description="公共建筑每个防火分区安全出口不应少于2个（GB50016-5.5.8）",
        ...
        # ── P57 扩展：补齐 5 条缺失子条款 ────────────────────────
        # GB50016-5.5.17-2: 袋形走道长度判定（DIM-094）
        # 高层建筑袋形走道尽端疏散距离不应大于15m，一二类建筑不应大于20m
        # 取保守值15m（高层建筑控制）
        AtomicFunction(
            func_id="DIM-094",
            name="袋形走道疏散距离判定",
        ...
        # GB50016-5.5.18-2: 疏散走道宽度判定（DIM-095）
        # 疏散走道最小净宽度：高层医疗建筑≥1.4m，其他≥1.2m，取保守1.2m
        AtomicFunction(
            func_id="DIM-095",
            name="疏散走道最小净宽度判定",
        ...
        # GB50016-5.5.18-3: 疏散出口宽度判定（DIM-096）
        # 疏散出口最小净宽度：医疗建筑≥0.9m，其他≥0.8m，取保守0.8m
        AtomicFunction(
            func_id="DIM-096",
            name="疏散出口最小净宽度判定",
        ...
        # GB50016-6.5.1-2: 防火窗等级判定（ATTR-013）
        # 防火窗的耐火极限不应低于1.00h，与防火墙连接的防火窗不低于1.50h
        AtomicFunction(
            func_id="ATTR-013",
            name="防火窗耐火极限判定",
        ...
        # GB50016-7.2.4-2: 消防救援窗面积判定（AREA-013）
        # 消防救援窗净面积不应小于1.0㎡
        AtomicFunction(
            func_id="AREA-013",
            name="消防救援窗净面积判定",
        ...
        # ── P57 扩展：扩展关键单函数条款为多维度 ────────────────
        # GB50016-3.4.1: 防火间距判定补充（DIST-029）
        # 高层民用建筑与高层民用建筑之间防火间距≥13m
        AtomicFunction(
            func_id="DIST-029",
            name="高层建筑防火间距判定",
        ...
        # GB50016-5.5.15: 房间疏散门数量判定补充（COUNT-020）
        # 房间面积大于50㎡时疏散门不应少于2个
        AtomicFunction(
            func_id="COUNT-020",
            name="大房间疏散门数量判定",
        ...
        # GB50016-5.5.25: 封闭楼梯间数量判定补充（COUNT-021）
        # 住宅建筑每个单元每层安全出口不应少于2个
        AtomicFunction(
            func_id="COUNT-021",
            name="住宅单元每层安全出口数量判定",
        ...
        # GB50016-5.5.29: 住宅安全出口数量判定补充（COUNT-022）
        # 18层及以下住宅每单元每层安全出口≥1个，18层以上≥2个
        AtomicFunction(
            func_id="COUNT-022",
        ...
        # GB50016-6.1.5: 防火墙上开设门窗洞口判定补充（EXIST-067）
        # 防火墙上不应开设门窗洞口，必须开设时需设甲级防火门窗
        AtomicFunction(
            func_id="EXIST-067",
            name="防火墙上洞口防火门窗判定",
        ...
        # GB50016-6.2.4: 建筑幕墙防火封堵宽度判定补充（DIM-097）
        # 幕墙与每层楼板、隔墙处的缝隙应采用防火封堵材料封堵，宽度≥0.2m
        AtomicFunction(
            func_id="DIM-097",
            name="幕墙防火封堵宽度判定",
        ...
        # GB50016-6.4.1: 楼梯间首层直通室外判定补充（EXIST-068）
        # 楼梯间应在首层直通室外，或经扩大的封闭楼梯间通向室外
        AtomicFunction(
            func_id="EXIST-068",
            name="楼梯间首层直通室外通道判定",
        ...
        # GB50016-6.6.1: 管道井封堵判定补充（EXIST-069）
        # 管道井在每层楼板处应采用不低于楼板耐火极限的不燃材料封堵
        AtomicFunction(
            func_id="EXIST-069",
            name="管道井层间防火封堵判定",
        ...
        # GB50016-7.1.1: 消防车道宽度判定补充（DIM-098）
        # 消防车道净宽度不应小于4.0m，净高不应小于4.0m
        AtomicFunction(
            func_id="DIM-098",
            name="消防车道净高判定",
        ...
        # GB50016-7.2.1: 消防救援场地面积判定补充（AREA-014）
        # 消防救援场地长度不应小于15m，宽度不应小于10m
        AtomicFunction(
            func_id="AREA-014",
            name="消防救援场地最小宽度判定",
        ...
        # GB50016-7.2.3: 救援窗口尺寸判定补充（DIM-099）
        # 救援窗口净高不应小于1.0m，净宽不应小于1.0m
        AtomicFunction(
            func_id="DIM-099",
            name="救援窗口最小净高判定",
        ...
        # GB50016-7.3.2: 消防电梯数量判定补充（COUNT-023）
        # 每个防火分区消防电梯数量不应少于1台
        AtomicFunction(
            func_id="COUNT-023",
            name="防火分区消防电梯数量判定",
        ...
        # GB50016-7.4.1: 避难层面积判定补充（AREA-015）
        # 避难层净面积不应小于5.0人/㎡（按5人/㎡计算）
        AtomicFunction(
            func_id="AREA-015",
            name="避难层人均面积判定",
        ...
        # GB50016-8.1.2: 消防水源判定补充（EXIST-070）
        # 消防水源应满足消防用水量和水压要求
        AtomicFunction(
            func_id="EXIST-070",
            name="消防水源可靠性判定",
        ...
        # GB50016-8.1.6: 消防控制室判定补充（EXIST-071）
        # 消防控制室应设置在首层或地下一层，疏散门应直通室外
        AtomicFunction(
            func_id="EXIST-071",
            name="消防控制室位置判定",
        ...
        # GB50016-8.1.7: 消防控制室面积判定补充（AREA-016）
        # 消防控制室面积不应小于20㎡
        AtomicFunction(
            func_id="AREA-016",
            name="消防控制室最小面积判定",
        ...
        # GB50016-8.3.1: 自动灭火系统判定补充（EXIST-072）
        # 一类高层民用建筑应设自动灭火系统
        AtomicFunction(
            func_id="EXIST-072",
            name="一类高层自动灭火系统判定",
        ...
        # GB50016-8.3.3: 自动喷水灭火系统判定补充（EXIST-073）
        # 二类高层建筑应设自动喷水灭火系统
        AtomicFunction(
            func_id="EXIST-073",
            name="二类高层自动喷水灭火系统判定",
        ...
        # GB50016-8.3.8: 气体灭火系统判定补充（EXIST-074）
        # 重要机房、贵重设备室应设气体灭火系统
        AtomicFunction(
            func_id="EXIST-074",
            name="重要机房气体灭火系统判定",
        ...
        # GB50016-8.5.3: 排烟设备判定补充（EXIST-075）
        # 民用建筑内长度大于20m的疏散走道应设排烟设施
        AtomicFunction(
            func_id="EXIST-075",
            name="疏散走道排烟设施判定",
        ...
        # GB50016-8.6.1: 消防专用电话判定补充（EXIST-076）
        # 消防控制室应设消防专用电话
        AtomicFunction(
            func_id="EXIST-076",
            name="消防专用电话设置判定",
        ...
        # GB50016-9.2.1: 排烟窗面积判定补充（AREA-017）
        # 自然排烟窗面积不应小于地面面积的2%
        AtomicFunction(
            func_id="AREA-017",
            name="自然排烟窗面积比判定",
        ...
        # GB50016-9.2.3: 排烟口与安全出口间距判定补充（DIST-030）
        # 排烟口与安全出口间距不应小于1.5m
        AtomicFunction(
            func_id="DIST-030",
            name="排烟口与安全出口间距判定",
        ...
        # GB50016-9.3.1: 机械排烟系统排烟量判定补充（DIM-100）
        # 机械排烟系统排烟量不应小于7200m³/h
        AtomicFunction(
            func_id="DIM-100",
            name="机械排烟系统最小排烟量判定",
        ...
        # GB50016-10.1.5: 应急照明照度判定补充（LIGHT-007）
        # 疏散走道应急照明照度不应低于1.0lx，楼梯间不应低于5.0lx
        AtomicFunction(
            func_id="LIGHT-007",
            name="楼梯间应急照明照度判定",
        ...
        # GB50016-10.1.6: 应急电源判定补充（EXIST-077）
        # 一类高层建筑消防用电应为一、二级负荷
        AtomicFunction(
            func_id="EXIST-077",
            name="一类高层消防电源负荷等级判定",
        ...
        # GB50016-10.2.1: 电气线路防火保护判定补充（EXIST-078）
        # 消防配电线路应穿管保护
        AtomicFunction(
            func_id="EXIST-078",
            name="消防配电线路穿管保护判定",
        ...
        # GB50016-10.2.3: 配电箱防火判定补充（EXIST-079）
        # 配电箱应设在不燃材料上，不应直接安装在可燃材料上
        AtomicFunction(
            func_id="EXIST-079",
            name="配电箱安装基材防火判定",
        ...
        # GB50016-10.3.3: 消防控制室应急照明照度判定补充（LIGHT-008）
        # 消防控制室应急照明照度不应低于1.0lx
        AtomicFunction(
            func_id="LIGHT-008",
            name="消防水泵房应急照明照度判定",
        ...
        # ===== P57 扩展第四批：GB50116 火灾自动报警（50 个，340→390）=====
        # GB50116-3.1.1: 火灾报警系统设置判定（EXIST-096）
        AtomicFunction(
            func_id="EXIST-096",
            name="火灾自动报警系统设置判定",
        ...
        # GB50116-3.1.2: 区域报警系统判定（EXIST-097）
        AtomicFunction(
            func_id="EXIST-097",
            name="区域报警系统判定",
        ...
        # GB50116-3.1.3: 集中报警系统判定（EXIST-098）
        AtomicFunction(
            func_id="EXIST-098",
            name="集中报警系统判定",
        ...
        # GB50116-3.1.4: 消防控制室判定（EXIST-099）
        AtomicFunction(
            func_id="EXIST-099",
            name="消防控制室设置判定",
        ...
        # GB50116-3.1.5: 消防控制室面积判定（AREA-022）
        AtomicFunction(
            func_id="AREA-022",
            name="消防控制室面积判定",
        ...
        # GB50116-3.2.1: 探测器类型选择判定（ATTR-020）
        AtomicFunction(
            func_id="ATTR-020",
            name="探测器类型匹配判定",
        ...
        # GB50116-3.2.2: 感烟探测器设置判定（EXIST-100）
        AtomicFunction(
            func_id="EXIST-100",
            name="感烟探测器设置判定",
        ...
        # GB50116-3.2.3: 感温探测器设置判定（EXIST-101）
        AtomicFunction(
            func_id="EXIST-101",
            name="感温探测器设置判定",
        ...
        # GB50116-3.2.4: 探测器保护面积判定（DIM-116）
        AtomicFunction(
            func_id="DIM-116",
            name="感烟探测器保护面积判定",
        ...
        # GB50116-3.2.5: 探测器保护半径判定（DIST-024）
        AtomicFunction(
            func_id="DIST-024",
            name="感烟探测器保护半径判定",
        ...
        # GB50116-3.2.6: 探测器间距判定（DIST-025）
        AtomicFunction(
            func_id="DIST-025",
            name="感烟探测器安装间距判定",
        ...
        # GB50116-3.2.7: 探测器距墙距离判定（DIST-026）
        AtomicFunction(
            func_id="DIST-026",
            name="探测器距墙距离判定",
        ...
        # GB50116-3.2.8: 探测器距空调距离判定（DIST-027）
        AtomicFunction(
            func_id="DIST-027",
            name="探测器距空调口距离判定",
        ...
        # GB50116-3.3.1: 手动报警按钮设置判定（EXIST-102）
        AtomicFunction(
            func_id="EXIST-102",
            name="手动报警按钮设置判定",
        ...
        # GB50116-3.3.2: 手动报警按钮间距判定（DIST-028）
        AtomicFunction(
            func_id="DIST-028",
            name="手动报警按钮间距判定",
        ...
        # GB50116-3.3.3: 手动报警按钮高度判定（DIM-117）
        AtomicFunction(
            func_id="DIM-117",
            name="手动报警按钮安装高度判定",
        ...
        # GB50116-3.4.1: 声光报警器设置判定（EXIST-103）
        AtomicFunction(
            func_id="EXIST-103",
            name="声光报警器设置判定",
        ...
        # GB50116-3.4.2: 声光报警器音量判定（DIM-118）
        AtomicFunction(
            func_id="DIM-118",
            name="声光报警器音量判定",
        ...
        # GB50116-3.5.1: 消防广播设置判定（EXIST-104）
        AtomicFunction(
            func_id="EXIST-104",
            name="消防广播系统设置判定",
        ...
        # GB50116-3.5.2: 消防广播功率判定（DIM-119）
        AtomicFunction(
            func_id="DIM-119",
            name="消防广播功率判定",
        ...
        # GB50116-3.6.1: 消防电话设置判定（EXIST-105）
        AtomicFunction(
            func_id="EXIST-105",
            name="消防电话设置判定",
        ...
        # GB50116-3.6.2: 消防应急广播联动判定（EXIST-106）
        AtomicFunction(
            func_id="EXIST-106",
            name="消防广播联动判定",
        ...
        # GB50116-3.7.1: 消防控制室图形显示判定（EXIST-107）
        AtomicFunction(
            func_id="EXIST-107",
            name="消防控制室图形显示判定",
        ...
        # GB50116-3.8.1: 消防控制室备用电源判定（EXIST-108）
        AtomicFunction(
            func_id="EXIST-108",
            name="消防控制室备用电源判定",
        ...
        # GB50116-3.8.2: 消防控制室接地判定（EXIST-109）
        AtomicFunction(
            func_id="EXIST-109",
            name="消防控制室接地判定",
        ...
        # ===== P57 扩展第五批：GB50116 继续（30 个，360→390）=====
        # GB50116-3.8.3: 消防控制室照明判定（LIGHT-011）
        AtomicFunction(
            func_id="LIGHT-011",
            name="消防控制室应急照明照度判定",
        ...
        # GB50116-4.1.1: 消防联动控制方式判定（ATTR-021）
        AtomicFunction(
            func_id="ATTR-021",
            name="消防联动控制方式判定",
        ...
        # GB50116-4.2.1: 消火栓联动控制判定（EXIST-110）
        AtomicFunction(
            func_id="EXIST-110",
            name="消火栓联动控制判定",
        ...
        # GB50116-4.3.1: 自动喷水联动控制判定（EXIST-111）
        AtomicFunction(
            func_id="EXIST-111",
            name="自动喷水联动控制判定",
        ...
        # GB50116-4.4.1: 气体灭火联动控制判定（EXIST-112）
        AtomicFunction(
            func_id="EXIST-112",
            name="气体灭火联动控制判定",
        ...
        # GB50116-4.5.1: 防火门联动控制判定（EXIST-113）
        AtomicFunction(
            func_id="EXIST-113",
            name="防火门联动控制判定",
        ...
        # GB50116-4.6.1: 防火卷帘联动控制判定（EXIST-114）
        AtomicFunction(
            func_id="EXIST-114",
            name="防火卷帘联动控制判定",
        ...
        # GB50116-4.7.1: 防排烟联动控制判定（EXIST-115）
        AtomicFunction(
            func_id="EXIST-115",
            name="防排烟联动控制判定",
        ...
        # GB50116-4.8.1: 消防应急广播联动判定（EXIST-116）
        AtomicFunction(
            func_id="EXIST-116",
            name="消防应急广播联动判定",
        ...
        # GB50116-4.9.1: 非消防电源联动切断判定（EXIST-117）
        AtomicFunction(
            func_id="EXIST-117",
            name="非消防电源联动切断判定",
        ...
        # GB50116-4.10.1: 电梯联动控制判定（EXIST-118）
        AtomicFunction(
            func_id="EXIST-118",
            name="电梯联动迫降判定",
        ...
        # GB50116-5.1.1: 探测器安装间距判定（DIST-029）
        AtomicFunction(
            func_id="DIST-029",
            name="走廊探测器安装间距判定",
        ...
        # GB50116-5.1.2: 探测器距梁距离判定（DIST-030）
        AtomicFunction(
            func_id="DIST-030",
            name="探测器距梁距离判定",
        ...
        # GB50116-5.2.1: 探测器安装高度判定（DIM-120）
        AtomicFunction(
            func_id="DIM-120",
            name="感烟探测器安装高度判定",
        ...
        # GB50116-5.2.2: 感温探测器安装高度判定（DIM-121）
        AtomicFunction(
            func_id="DIM-121",
            name="感温探测器安装高度判定",
        ...
        # GB50116-5.3.1: 探测器数量判定（COUNT-027）
        AtomicFunction(
            func_id="COUNT-027",
            name="每个房间探测器数量判定",
        ...
        # GB50116-5.3.2: 探测器数量面积比判定（COUNT-028）
        AtomicFunction(
            func_id="COUNT-028",
            name="探测器数量面积比判定",
        ...
        # GB50116-6.1.1: 手动报警按钮安装高度判定（DIM-122）
        AtomicFunction(
            func_id="DIM-122",
            name="手动报警按钮安装高度上限判定",
        ...
        # GB50116-6.2.1: 声光报警器安装间距判定（DIST-031）
        AtomicFunction(
            func_id="DIST-031",
            name="声光报警器安装间距判定",
        ...
        # GB50116-6.3.1: 消防广播扬声器间距判定（DIST-032）
        AtomicFunction(
            func_id="DIST-032",
            name="消防广播扬声器间距判定",
        ...
        # GB50116-6.4.1: 消防电话分机设置判定（EXIST-119）
        AtomicFunction(
            func_id="EXIST-119",
            name="消防电话分机设置判定",
        ...
        # GB50116-6.5.1: 消防应急照明持续供电时间判定（DIM-123）
        AtomicFunction(
            func_id="DIM-123",
            name="消防应急照明持续供电时间判定",
        ...
        # GB50116-6.6.1: 消防控制室电缆敷设判定（EXIST-120）
        AtomicFunction(
            func_id="EXIST-120",
            name="消防控制室电缆保护判定",
        ...
        # GB50116-6.7.1: 消防系统接地电阻判定（DIM-124）
        AtomicFunction(
            func_id="DIM-124",
            name="消防系统接地电阻判定",
        ...
        # GB50116-7.1.1: 系统供电电源判定（EXIST-121）
        AtomicFunction(
            func_id="EXIST-121",
            name="消防报警系统双电源判定",
        ...
        # ===== P57 扩展第六批：最后 7 个（383→390）=====
        # GB50116-7.2.1: 系统布线防火判定（EXIST-122）
        AtomicFunction(
            func_id="EXIST-122",
            name="消防报警系统布线保护判定",
        ...
        # GB50116-7.3.1: 系统防雷接地判定（EXIST-123）
        AtomicFunction(
            func_id="EXIST-123",
            name="消防报警系统防雷接地判定",
        ...
        # GB50116-8.1.1: 系统验收判定（COUNT-029）
        # 系统验收应检查全部设备
        AtomicFunction(
            func_id="COUNT-029",
            name="消防报警系统验收设备数量判定",
        ...
        # GB50116-8.2.1: 系统维护判定（EXIST-124）
        # 系统应定期维护
        AtomicFunction(
            func_id="EXIST-124",
            name="消防报警系统维护判定",
        ...
        # GB50116-3.2.9: 探测器选型判定（ATTR-023）
        # 探测器选型应匹配场所特征
        AtomicFunction(
            func_id="ATTR-023",
            name="探测器选型匹配判定",
        ...
        # GB50116-3.3.4: 手动报警按钮保护判定（DIM-125）
        # 手动报警按钮应设明显标志
        AtomicFunction(
            func_id="DIM-125",
            name="手动报警按钮标志判定",

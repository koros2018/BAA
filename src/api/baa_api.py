...
@app.post("/collab/auth/register", tags=["Collaboration"])
...
@app.get("/collab/users/me", tags=["Collaboration"])
...
@app.put("/collab/users/me", tags=["Collaboration"])
...
@app.get("/collab/users/search", tags=["Collaboration"])
...
@app.post("/collab/teams", tags=["Collaboration"])
...
@app.get("/collab/teams", tags=["Collaboration"])
...
@app.get("/collab/teams/{team_id}", tags=["Collaboration"])
...
@app.post("/collab/teams/{team_id}/members", tags=["Collaboration"])
...
@app.delete("/collab/teams/{team_id}/members/{target_id}", tags=["Collaboration"])
...
@app.post("/collab/projects", tags=["Collaboration"])
...
@app.get("/collab/projects", tags=["Collaboration"])
...
@app.get("/collab/projects/{project_id}", tags=["Collaboration"])
...
@app.post("/collab/projects/{project_id}/members", tags=["Collaboration"])
...
@app.put("/collab/projects/{project_id}/members/{target_id}", tags=["Collaboration"])
...
@app.delete("/collab/projects/{project_id}/members/{target_id}", tags=["Collaboration"])
...
@app.get("/collab/teams/{team_id}/projects", tags=["Collaboration"])
...
@app.post("/collab/review-sessions", tags=["Collaboration"])
...
@app.get("/collab/projects/{project_id}/review-sessions", tags=["Collaboration"])
...
@app.get("/collab/review-sessions/{session_id}", tags=["Collaboration"])
...
@app.put("/collab/review-sessions/{session_id}/status", tags=["Collaboration"])
...
@app.post("/collab/review-sessions/{session_id}/comments", tags=["Collaboration"])
...
@app.get("/collab/review-sessions/{session_id}/comments", tags=["Collaboration"])
...
@app.put("/collab/comments/{comment_id}/resolve", tags=["Collaboration"])
...
@app.post("/collab/review-sessions/{session_id}/approval-flow", tags=["Collaboration"])
...
@app.get("/collab/review-sessions/{session_id}/approval-flow", tags=["Collaboration"])
...
@app.post("/collab/approval-steps/{step_id}/approve", tags=["Collaboration"])
...
@app.post("/collab/approval-steps/{step_id}/reject", tags=["Collaboration"])
...
@app.get("/collab/stats", tags=["Collaboration"])
